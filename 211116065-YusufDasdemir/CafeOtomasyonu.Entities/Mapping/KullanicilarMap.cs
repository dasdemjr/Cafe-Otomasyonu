...
namespace CafeOtomasyonu.Entities.Mapping
{
    public class KullanicilarMap : EntityTypeConfiguration<Kullanicilar>
    {
        public KullanicilarMap()
        {
            ...
            this.Property(p => p.Sifre).HasColumnType("varchar").HasMaxLength(20);
            ...
            this.Property(p => p.HatirlatmaSorusu).HasColumnType("varchar").HasMaxLength(100);
            this.Property(p => p.Cevap).HasColumnType("varchar").HasMaxLength(100);
